...
/**
 * Gets or Sets getOffers_carType_parameter
 */
@Serdeable
@Generated("io.micronaut.openapi.generator.JavaMicronautServerCodegen")
public enum GetOffersCarTypeParameter {
    ...
    public final static Map<String, GetOffersCarTypeParameter> VALUE_MAPPING = Map.copyOf(Arrays.stream(values())
            .collect(Collectors.toMap(v -> v.value, Function.identity())));

    private final String value;

    GetOffersCarTypeParameter(String value) {
        this.value = value;
    }
     ...
     */
    @JsonCreator
    public static GetOffersCarTypeParameter fromValue(String value) {
